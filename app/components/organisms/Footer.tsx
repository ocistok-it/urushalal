  ...
  return (
    <footer>
      <div className="bg-teal-25 py-16 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              ...
              <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 text-gray-700 text-sm mb-8">
                ...
                <span>
                  <strong>Whatsapp:</strong> +62 813 1515 951
                </span>
              </a>
        ...
        <span className="text-[#707070] text-sm mt-6 block text-center">Copyright © 2026 UrusHalal. All Rights Reserved</span>
      </div>
    </footer>
  )
}
